    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
        ...
        <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown">
                <a class="nav-link TIbox" data-toggle="dropdown" href="#">
                    <i class="far fa-comments"></i>
                    <span class="badge badge-danger navbar-badge">3</span>
                </a>
                <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right Brad">
                    <div class="DropDown_Title">
                        <h3>Massage Box</h3>
                        <p>15 Unread Massage</p>
                    </div>
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right Brad Second">
                    <div class="drop_2Title"><span class="dropdown-item dropdown-header">15 Notifications</span></div>
                    <div class="dropdown-divider"></div>
                    <a href="#" class="dropdown-item">
